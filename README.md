A simple note taking app called Scratch. It is a single page application powered by a serverless API written completely in JavaScript. This is the complete source for the backend. The frontend code is located at https://github.com/quiyetbrul/serverless-stack-client
...
The app is deployed on the AWS Platform at http://d1koxugtz4gc2e.cloudfront.net/
